...
type GroupEdges struct {
	...
	// Protocol holds the value of the protocol edge.
...
// ProtocolOrErr returns the Protocol value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e GroupEdges) ProtocolOrErr() (*Protocol, error) {
	if e.Protocol != nil {
		return e.Protocol, nil
	} else if e.loadedTypes[4] {
		return nil, &NotFoundError{label: protocol.Label}
	}
	return nil, &NotLoadedError{edge: "protocol"}
}
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldID, group.FieldDefaultValidityDays, group.FieldFallbackGroupID, group.FieldFallbackGroupIDOnInvalidRequest, group.FieldSortOrder, group.FieldRpmLimit, group.FieldProtocolID:
...
// QueryProtocol queries the "protocol" edge of the Group entity.
func (_m *Group) QueryProtocol() *ProtocolQuery {
	return NewGroupClient(_m.config).QueryProtocol(_m)
}
