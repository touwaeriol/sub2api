...
func (m *NoteMutation) SetAccountID(i int64) {
	m.account_id = &i
	m.addaccount_id = nil
}

// AccountID returns the value of the "account_id" field in the mutation.
func (m *NoteMutation) AccountID() (r int64, exists bool) {
	v := m.account_id
	if v == nil {
		return
	}
...
// OldAccountID returns the old "account_id" field's value of the Note entity.
// If the Note object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *NoteMutation) OldAccountID(ctx context.Context) (v int64, err error) {
...
func (m *NoteMutation) AddAccountID(i int64) {
...
func (m *NoteMutation) AddedAccountID() (r int64, exists bool) {
	v := m.addaccount_id
	if v == nil {
		return
	}
...
func (m *NoteMutation) ResetAccountID() {
	m.account_id = nil
	m.addaccount_id = nil
}
...
func (m *NoteMutation) Fields() []string {
	...
	if m.account_id != nil {
		fields = append(fields, note.FieldAccountID)
	}
	if m.content != nil {
