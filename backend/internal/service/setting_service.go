...
func (s *SettingService) buildSystemSettingsUpdates(ctx context.Context, settings *SystemSettings) (map[string]string, error) {
	...
	u.SetBool(SettingKeyLoginAgreementEnabled, settings.LoginAgreementEnabled)
	u.SetString(SettingKeyLoginAgreementMode, settings.LoginAgreementMode)
	u.SetString(SettingKeyLoginAgreementUpdatedAt, settings.LoginAgreementUpdatedAt)
	u.SetString(SettingKeyLoginAgreementDocuments, loginAgreementDocumentsJSON)
	...
	u.SetBool(SettingKeyAPIKeyACLTrustForwardedIP, settings.APIKeyACLTrustForwardedIP)
	...
	u.SetBool(SettingKeyDingTalkConnectEnabled, settings.DingTalkConnectEnabled)
	u.SetString(SettingKeyDingTalkConnectClientID, settings.DingTalkConnectClientID)
	u.SetString(SettingKeyDingTalkConnectRedirectURL, settings.DingTalkConnectRedirectURL)
	u.SetStringIfNotEmpty(SettingKeyDingTalkConnectClientSecret, settings.DingTalkConnectClientSecret)
	u.SetString(SettingKeyDingTalkConnectCorpRestrictionPolicy, settings.DingTalkConnectCorpRestrictionPolicy)
	u.SetString(SettingKeyDingTalkConnectInternalCorpID, settings.DingTalkConnectInternalCorpID)
	u.SetBool(SettingKeyDingTalkConnectBypassRegistration, settings.DingTalkConnectBypassRegistration)
	u.SetBool(SettingKeyDingTalkConnectSyncCorpEmail, settings.DingTalkConnectSyncCorpEmail)
	u.SetBool(SettingKeyDingTalkConnectSyncDisplayName, settings.DingTalkConnectSyncDisplayName)
	u.SetBool(SettingKeyDingTalkConnectSyncDept, settings.DingTalkConnectSyncDept)
	u.SetString(SettingKeyDingTalkConnectSyncCorpEmailAttrKey, settings.DingTalkConnectSyncCorpEmailAttrKey)
	u.SetString(SettingKeyDingTalkConnectSyncDisplayNameAttrKey, settings.DingTalkConnectSyncDisplayNameAttrKey)
	u.SetString(SettingKeyDingTalkConnectSyncDeptAttrKey, settings.DingTalkConnectSyncDeptAttrKey)
	u.SetString(SettingKeyDingTalkConnectSyncCorpEmailAttrName, settings.DingTalkConnectSyncCorpEmailAttrName)
	u.SetString(SettingKeyDingTalkConnectSyncDisplayNameAttrName, settings.DingTalkConnectSyncDisplayNameAttrName)
	u.SetString(SettingKeyDingTalkConnectSyncDeptAttrName, settings.DingTalkConnectSyncDeptAttrName)
	...
	u.SetStringIfNotEmpty(SettingKeyGitHubOAuthClientSecret, strings.TrimSpace(settings.GitHubOAuthClientSecret))
	...
	u.SetStringIfNotEmpty(SettingKeyGoogleOAuthClientSecret, strings.TrimSpace(settings.GoogleOAuthClientSecret))
	...
	u.SetString(SettingKeyOpenAICodexUserAgent, strings.TrimSpace(settings.OpenAICodexUserAgent))
	u.SetBool(SettingKeyOpenAIAllowClaudeCodeCodexPlugin, settings.OpenAIAllowClaudeCodeCodexPlugin)
	...
	u.SetBool(SettingKeySubscriptionExpiryNotifyEnabled, settings.SubscriptionExpiryNotifyEnabled)
	...
	if settings.DefaultPlatformQuotas != nil {
		...
		u.updates[SettingKeyDefaultPlatformQuotas] = string(blob)
	}

	u.SetBool(SettingKeyAllowUserViewErrorRequests, settings.AllowUserViewErrorRequests)
