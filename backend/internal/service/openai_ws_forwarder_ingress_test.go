...
func TestIsOpenAIWSClientDisconnectError(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "windows_wsasend_connection_aborted", err: errors.New("write tcp 127.0.0.1:1234->127.0.0.1:5678: wsasend: An established connection was aborted by the software in your host machine."), want: true},
	}
