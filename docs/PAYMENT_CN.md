...
> **国际收款推荐**：[启润支付](https://kyren.top/?code=SUB2API)（`https://kyren.top/?code=SUB2API`）为 AI 项目提供低门槛国际收款通道，支持国际版微信支付与支付宝，本地货币支付、美元结算（链接含 Sub2Api 作者 [@Wei-Shaw](https://github.com/Wei-Shaw) 邀请码，介意可去掉）。手续费：微信支付 2%、支付宝 2.5%；提现 0.1%（最低 40 美元、最高 150 美元）。提现以 **USDT 或美元**到账。启润支付无资质审核、注册即用，使用门槛最低；提现门槛略高，适合**不使用国内支付渠道、无法接受 Stripe 高达 6%+ 手续费、流水较大，且拥有美元或 USDT 渠道可接收提现资金**的用户。支付渠道的安全性、稳定性及合规性请自行鉴别，本项目不对任何第三方支付服务商做担保或背书。
