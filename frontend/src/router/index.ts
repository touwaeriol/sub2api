...
import { resolveDocumentTitle, resolveDocumentMeta } from './title'
...
router.beforeEach((to, _from, next) => {
  ...
  if (to.name === 'CustomPage') {
    ...
    if (menuItem?.label) {
      ...
      document.title = resolveDocumentTitle(to.meta.title, appStore.siteName, to.meta.titleKey as string, to.meta.omitSiteName === true)
    }
  } else {
    document.title = resolveDocumentTitle(to.meta.title, appStore.siteName, to.meta.titleKey as string, to.meta.omitSiteName === true)
  }

  // Sync SEO meta description / keywords from route meta (optional per-route)
  resolveDocumentMeta(to.meta.descriptionKey as string | undefined, to.meta.keywordsKey as string | undefined)
