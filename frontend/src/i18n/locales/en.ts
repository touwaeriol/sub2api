export default {
  // Brand strings — locale-specific overrides for site name / tagline.
  // Leave empty to inherit the admin `site_name` / `site_subtitle` value.
  brand: {
    name: 'anthropic.mom',
    tagline: 'Upstream relay for every frontier model.'
  },

  // SEO metadata
  seo: {
    home: {
      title: 'Claude \u2014 One API. Every frontier model.',
      description:
        'One API key to Claude, GPT, Gemini and more. Pay only for tokens you actually use \u2014 no subscriptions to juggle, no accounts to manage. Drop-in replacement for the Anthropic and OpenAI SDKs.',
      keywords:
        'Claude API, Anthropic API, Claude Opus 4, Claude Sonnet 4, Claude Haiku, 1M context, OpenAI API, GPT-4, GPT-5, Gemini API, AI API gateway, unified AI API, drop-in replacement, pay-as-you-go AI, AI relay, Claude proxy, Anthropic SDK compatible, OpenAI compatible endpoint'
    }
  },
  ...
  home: {
    ...
    tryClaude: 'Try Claude',
    goToDashboard: 'Go to Dashboard',
    // User-focused value proposition
    heroSubtitle: 'Build with frontier intelligence.',
    heroDescription: 'One API. Every leading model. Pay only for what you actually use — no subscriptions to juggle, no accounts to manage.',
    eyebrow: {
      platform: 'The API Platform',
    ...
    editorial: {
      capabilitiesTitle: 'Everything you need to ship with large models.',
      modelsTitle: 'One API.\nEvery leading model.',
      docsTitle: 'Start shipping in minutes.',
      ctaTitle: 'Start building today.',
      ctaBody: 'A single key. Every frontier model. Usage-based pricing. Everything you need, and nothing you don\u2019t.'
    },
    nav: {
      meetClaude: 'Meet Claude',
      platform: 'Platform',
      solutions: 'Solutions',
      capabilities: 'Capabilities',
      models: 'Models',
    ...
    heroRightTitle: 'Every frontier model\nat one endpoint',
    trust: {
      sdk: 'Anthropic SDK compatible',
      openai: 'OpenAI-compatible endpoint',
      dropin: 'Drop-in replacement'
    },
    tags: {
      subscriptionToApi: 'API Platform',
    ...
    pricing: {
      ...
      subtitle: 'Flexible pricing for every scale',
      monthly: '/ mo',
      perMToken: '/ 1M Tokens',
      ...
      plans: {
        free: {
          ...
          features: ['Limited daily quota', 'Basic model access', 'Community support', '1 API Key']
        },
        pro: {
          name: 'Pro',
          price: '$15',
          desc: 'For developers and power users',
          features: ['Pay-as-you-go billing', 'All model access', 'Priority support', '5 API Keys', 'Usage dashboard']
        },
        team: {
          name: 'Team',
          price: 'Custom',
          desc: 'For teams and enterprises',
          features: ['Unlimited quota', 'All model access', 'Dedicated support', 'Unlimited API Keys', 'Team management', 'SLA guarantee']
        }
      }
    },
    whyChoose: {
      ...
      subtitle: 'Built for developers who ship with frontier models every day.',
      items: {
        pricing: {
          title: 'Affordable pricing',
          desc: 'Subscription-level rates, but you only pay for tokens you actually consume \u2014 far friendlier than direct billing.'
        },
        stable: {
          title: 'Stable and reliable',
          desc: 'Multi-node load balancing on enterprise-grade infrastructure. Automatic failover keeps your workloads running.'
        },
        instant: {
          title: 'Instant activation',
          desc: 'Get your key the moment you pay. No manual review, no waiting room, no delays.'
        },
        models: {
          title: 'All frontier models',
          desc: 'Claude, GPT, Gemini and more \u2014 switch between them with a single API key.'
        },
        latency: {
          title: 'Low-latency routing',
          desc: 'Smart routing picks the fastest upstream for every request, so your app feels instant.'
        },
        support: {
          title: 'Human support',
          desc: 'Real engineers on standby. When something breaks, a person answers within hours, not days.'
        }
      }
    },
    channels: {
      eyebrow: 'Pricing',
      title: 'Pick the channel that fits your workload.',
      subtitle: 'Route through different upstream providers at different rates. All billed in real USD credits that never expire.',
      viewAll: 'Compare all channels',
      currentRate: 'Current rate',
      creditLine: '1 CNY \u2248 {usd} USD credit',
      supportedModels: 'Supported models',
      features: 'Features',
      andMore: '+{n} more',
      fineprint: 'No commitment \u00b7 Cancel anytime',
      cta: 'Get started'
    },
    faq: {
      eyebrow: 'FAQ',
      title: 'Common questions.',
      subtitle: 'Answers to the questions we get asked most. Can\u2019t find yours? Contact us.',
      items: {
        buy: {
          q: 'How do I purchase credits?',
          a: 'Sign in, open the billing page, pick a plan and pay with Alipay, WeChat Pay, or Stripe. Credits land in your account within a few seconds.'
        },
        activate: {
          q: 'How do I start using my API key?',
          a: 'After signup we generate a key with the sk- prefix. Use it as a drop-in replacement for the upstream provider\u2019s base URL \u2014 no SDK changes required. Full integration guide in the docs.'
        },
        expiry: {
          q: 'Do credits expire?',
          a: 'No. Credits never expire. Top up whenever you need more; they accumulate indefinitely on your account.'
        },
        models: {
          q: 'Which AI models are supported?',
          a: 'All current Claude models (Opus / Sonnet / Haiku, including the 1M-context variants), GPT-4 / 4o / 5, Gemini 2.x, and provider-specific codes like Codex. We add new models as upstream providers release them.'
        },
        refund: {
          q: 'Can I get a refund?',
          a: 'Yes. Unused credits can be refunded within 7 days of purchase. Email support with your order ID and we\u2019ll process it within 24 hours.'
        },
        support: {
          q: 'How do I get technical support?',
          a: "Email {'hi@anthropic.mom'} or reach out via the in-app chat. Most questions are answered within a few hours on business days."
        }
      }
    },
    ...
    docs: {
      ...
      quickStart: {
        title: 'Quick Start',
        desc: 'Get your first API response in 5 minutes'
      },
      apiRef: {
        title: 'API Reference',
        desc: 'Complete API documentation, OpenAI-compatible'
      },
      models: {
        title: 'Model List',
        desc: 'View all available models, capabilities and pricing'
      },
      faq: {
        title: 'FAQ',
  ...
  docs: {
    ...
    welcomeDescription: 'Select a document from the sidebar to start reading.',
