  ...
  admin: {
    ...
    channels: {
      ...
      form: {
        ...
        signaturePool: 'Signature Pool',
        signaturePoolHint: '⚠️ Collect valid thinking signatures from successful responses and retry with pool signatures on 400 signature errors',
        signaturePoolKeywords: 'Error keywords (comma separated)',
