export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      quotaLimitAmount: 'Total Limit Amount',
      quotaLimitAmountHint: 'Maximum total spending limit (USD). Account will be auto-paused when reached. Changing limit won\'t reset usage.',
      quotaDailyLimit: 'Daily Limit Amount',
      quotaDailyLimitPlaceholder: 'Max daily spending (USD), 0 or empty for unlimited',
      quotaDailyLimitHint: 'Rolling 24-hour reset. Account paused when exceeded.',
      quotaWeeklyLimit: 'Weekly Limit Amount',
      quotaWeeklyLimitPlaceholder: 'Max weekly spending (USD), 0 or empty for unlimited',
      quotaWeeklyLimitHint: 'Rolling 7-day reset. Account paused when exceeded.',
      testConnection: 'Test Connection',
