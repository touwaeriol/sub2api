export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      quotaLimitAmount: '总限额金额',
      quotaLimitAmountHint: '账号最大可用总额度（美元），达到后自动暂停。修改限额不会重置已用额度。',
      quotaDailyLimit: '日限额金额',
      quotaDailyLimitPlaceholder: '每日最大额度（美元），0 或留空表示不限制',
      quotaDailyLimitHint: '每 24 小时滚动重置，超限后自动暂停调度',
      quotaWeeklyLimit: '周限额金额',
      quotaWeeklyLimitPlaceholder: '每周最大额度（美元），0 或留空表示不限制',
      quotaWeeklyLimitHint: '每 7 天滚动重置，超限后自动暂停调度',
      testConnection: '测试连接',
      reAuthorize: '重新授权',
      refreshToken: '刷新令牌',
      noAccountsYet: '暂无账号',
