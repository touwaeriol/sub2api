      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <div class="card">
          ...
          <div class="space-y-6 p-6">
            ...
            <!-- Home Config (editorial homepage JSON, multi-language) -->
            <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
              <div class="mb-2 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3 text-xs">
                  <button
                    ...
                    @click="loadHomeConfigTemplate"
                  >Load template</button>
                  <button
                    type="button"
                    class="font-medium text-gray-500 hover:text-gray-700 dark:text-gray-400"
                    @click="formatHomeConfig"
                  >Format</button>
                  <span
                    v-if="homeConfigError"
                    class="font-medium text-red-500"
                  >× {{ homeConfigError }}</span>
                  <span
                    v-else-if="form.home_config && form.home_config.trim()"
                    class="font-medium text-green-600 dark:text-green-400"
                  >✓ Valid JSON</span>
                </div>
              </div>
              <textarea
                v-model="form.home_config"
                rows="14"
                spellcheck="false"
                class="input font-mono text-xs leading-[1.55]"
                placeholder='{"hero":{"title":{"en":"...","zh":"..."}}, "channels":{"items":[...]}, "faq":{"items":[...]} }'
                @blur="validateHomeConfig"
              ></textarea>
              <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                Editorial homepage content (hero / why-choose / channels / comparison / FAQ). Each text field accepts a string or <code class="rounded bg-gray-100 px-1 dark:bg-dark-700">{ "en": "...", "zh": "..." }</code> for multi-language. Leave empty to use the i18n defaults. Schema details:
                <code class="rounded bg-gray-100 px-1 dark:bg-dark-700">dev.local.md → home_config</code>
              </p>
            </div>
...
// ---------- home_config JSON editor helpers ----------
const homeConfigError = ref<string>('')
const HOME_CONFIG_TEMPLATE = `{
  "hero": {
    "eyebrow": { "en": "The API Platform", "zh": "AI \u5e73\u53f0" },
    "title":   { "en": "Build with frontier intelligence.", "zh": "\u7528\u524d\u6cbf\u667a\u80fd\u6784\u5efa\u4ea7\u54c1\u3002" },
    "description": {
      "en": "One API. Every leading model. Pay only for what you actually use.",
      "zh": "\u4e00\u4e2a API\u3002\u6240\u6709\u524d\u6cbf\u6a21\u578b\u3002\u6309\u5b9e\u9645\u7528\u91cf\u8ba1\u8d39\u3002"
    }
  },
  "trust": [
    { "en": "Anthropic SDK compatible", "zh": "Anthropic SDK \u517c\u5bb9" },
    { "en": "OpenAI-compatible endpoint", "zh": "OpenAI \u683c\u5f0f\u517c\u5bb9" },
    { "en": "Drop-in replacement", "zh": "\u65e0\u9700\u6539\u4ee3\u7801\uff0c\u76f4\u63a5\u66ff\u6362" }
  ],
  "whyChoose": {
    "eyebrow": { "en": "Why us", "zh": "\u4e3a\u4ec0\u4e48\u9009\u6211\u4eec" },
    "title":   { "en": "Everything you need, nothing you don\u2019t.", "zh": "\u4f60\u9700\u8981\u7684\u90fd\u5728\u8fd9\u91cc\uff0c\u4f60\u4e0d\u9700\u8981\u7684\u4e00\u4e2a\u4e5f\u6ca1\u6709\u3002" },
    "subtitle": { "en": "Built for developers who ship every day.", "zh": "\u4e3a\u6bcf\u5929\u90fd\u5728\u548c\u524d\u6cbf\u6a21\u578b\u6253\u4ea4\u9053\u7684\u5f00\u53d1\u8005\u6253\u9020\u3002" },
    "items": [
      { "icon": "dollar", "title": { "en": "Affordable", "zh": "\u5b9e\u60e0\u4ef7\u683c" }, "desc": { "en": "Subscription-level rates, pay only for tokens used.", "zh": "\u8ba2\u9605\u7ea7\u4ef7\u683c\uff0c\u53ea\u4e3a\u5b9e\u9645\u7528\u91cf\u4ed8\u8d39\u3002" } },
      { "icon": "shield", "title": { "en": "Reliable", "zh": "\u7a33\u5b9a\u53ef\u9760" }, "desc": { "en": "Multi-node failover keeps your workloads running.", "zh": "\u591a\u8282\u70b9\u8d1f\u8f7d\u5747\u8861\uff0c\u4e1a\u52a1\u4e0d\u6389\u7ebf\u3002" } },
      { "icon": "bolt",   "title": { "en": "Instant", "zh": "\u5373\u65f6\u6fc0\u6d3b" }, "desc": { "en": "Get your key the moment you pay.", "zh": "\u4ed8\u6b3e\u5373\u5230\u8d26\uff0c\u65e0\u9700\u7b49\u5f85\u3002" } },
      { "icon": "cube",   "title": { "en": "All models", "zh": "\u6db5\u76d6\u6240\u6709\u524d\u6cbf\u6a21\u578b" }, "desc": { "en": "Claude, GPT, Gemini and more, one key.", "zh": "Claude\u3001GPT\u3001Gemini\uff0c\u4e00\u4e2a\u5bc6\u94a5\u5168\u90e8\u642f\u5b9a\u3002" } },
      { "icon": "clock",  "title": { "en": "Low latency", "zh": "\u4f4e\u5ef6\u8fdf\u8def\u7531" }, "desc": { "en": "Smart routing picks the fastest upstream.", "zh": "\u667a\u80fd\u8def\u7531\u9009\u62e9\u6700\u5feb\u4e0a\u6e38\u8282\u70b9\u3002" } },
      { "icon": "chat",   "title": { "en": "Human support", "zh": "\u771f\u4eba\u652f\u6301" }, "desc": { "en": "Real engineers answer in hours, not days.", "zh": "\u5de5\u7a0b\u5e08\u5728\u7ebf\u54cd\u5e94\uff0c\u4ee5\u5c0f\u65f6\u8ba1\u3002" } }
    ]
  },
  "channels": {
    "eyebrow": { "en": "Pricing", "zh": "\u5b9a\u4ef7" },
    "title":   { "en": "Pick the channel that fits your workload.", "zh": "\u6309\u4f60\u7684\u4e1a\u52a1\u91cf\u6311\u9009\u5408\u9002\u7684\u6e20\u9053\u3002" },
    "subtitle": { "en": "Different upstream providers at different rates. USD credits never expire.", "zh": "\u4e0d\u540c\u4e0a\u6e38\u6e20\u9053\u4e0d\u540c\u500d\u7387\u3002\u7f8e\u5143\u989d\u5ea6\u6c38\u4e0d\u8fc7\u671f\u3002" },
    "items": [
      {
        "name": "AWS Bedrock", "badge": "Claude",
        "tagline": { "en": "Enterprise Claude via AWS", "zh": "AWS \u4f01\u4e1a\u7ea7\u63a5\u5165" },
        "rate": "5", "credit": "0.20",
        "desc": { "en": "Production-grade Claude routed through AWS.", "zh": "\u9002\u5408\u751f\u4ea7\u73af\u5883\u3002" },
        "models": ["claude-opus-4-6 (1M)", "claude-opus-4-5", "claude-sonnet-4-6", "claude-sonnet-4-5", "claude-haiku-4-5"],
        "features": [
          { "en": "AWS managed", "zh": "AWS \u5b98\u65b9\u6258\u7ba1" },
          { "en": "200k context", "zh": "200k \u4e0a\u4e0b\u6587" },
          { "en": "WebSearch", "zh": "\u652f\u6301 WebSearch" }
        ],
        "icon": "bedrock"
      },
      {
        "name": "Claude Max", "badge": "Claude",
        "tagline": { "en": "Full throughput, full context", "zh": "\u6700\u9ad8\u541e\u5410" },
        "rate": "2.1", "credit": "0.48",
        "desc": { "en": "Official Max 20x pool — best throughput and quality.", "zh": "\u5b98\u65b9 Max 20x \u8d26\u53f7\u6c60\uff0c\u541e\u5410\u4e0e\u6548\u679c\u6700\u4f73\u3002" },
        "models": ["claude-opus-4-6 (1M)", "claude-opus-4-5", "claude-sonnet-4-6", "claude-sonnet-4-5", "claude-haiku-4-5"],
        "features": [
          { "en": "Full thinking", "zh": "\u652f\u6301\u6ee1\u8840 thinking" },
          { "en": "1M context", "zh": "1M \u4e0a\u4e0b\u6587" },
          { "en": "WebSearch", "zh": "\u652f\u6301 WebSearch" }
        ],
        "icon": "max",
        "highlight": true
      ...
      {
        "name": "CC-Antigravity", "badge": "Claude",
        "tagline": { "en": "Balanced price & performance", "zh": "\u6027\u4ef7\u6bd4\u5747\u8861" },
        "rate": "1", "credit": "1.00",
        "desc": { "en": "Reverse channel for cost-sensitive workloads.", "zh": "\u9002\u5408\u6210\u672c\u654f\u611f\u573a\u666f\u3002" },
        "models": ["claude-opus-4-6 (1M)", "claude-sonnet-4-6 (1M)", "claude-opus-4-5", "claude-haiku-4-5"],
        "features": [
          { "en": "thinking", "zh": "\u652f\u6301 thinking" },
          { "en": "200k context", "zh": "200k \u4e0a\u4e0b\u6587" },
          { "en": "WebSearch", "zh": "\u652f\u6301 WebSearch" }
        ],
        "icon": "orbit"
  ...
  "comparison": {
    "eyebrow": { "en": "Why Choose Us?", "zh": "\u4e3a\u4ec0\u4e48\u9009\u62e9\u6211\u4eec" },
    "title":   { "en": "Start building today.", "zh": "\u4eca\u5929\u5f00\u59cb\u6784\u5efa\u3002" },
    "body":    { "en": "A single key. Every frontier model. Usage-based pricing.", "zh": "\u4e00\u4e2a\u5bc6\u94a5\uff0c\u6240\u6709\u524d\u6cbf\u6a21\u578b\uff0c\u6309\u91cf\u8ba1\u8d39\u3002" },
    "headers": {
      "feature":  { "en": "Comparison",            "zh": "\u5bf9\u6bd4\u9879" },
      "official": { "en": "Official Subscriptions","zh": "\u5b98\u65b9\u8ba2\u9605" },
      "us":       { "en": "Our Platform",          "zh": "\u6211\u4eec\u7684\u5e73\u53f0" }
    },
    "items": [
      {
        "feature":  { "en": "Pricing",        "zh": "\u4ef7\u683c" },
        "official": { "en": "Fixed monthly fee","zh": "\u6709\u56fa\u5b9a\u6708\u8d39" },
        "us":       { "en": "Pay only for what you use","zh": "\u6309\u7528\u91cf\u4ed8\u8d39" }
      }
    ]
  },
  "faq": {
    "eyebrow":  { "en": "FAQ",                "zh": "\u5e38\u89c1\u95ee\u9898" },
    "title":    { "en": "Common questions.",  "zh": "\u5e38\u89c1\u95ee\u9898\u89e3\u7b54\u3002" },
    "subtitle": { "en": "Answers to what we get asked most.","zh": "\u88ab\u95ee\u5f97\u6700\u591a\u7684\u95ee\u9898\u3002" },
    "items": [
      {
        "q": { "en": "How do I purchase credits?", "zh": "\u5982\u4f55\u8d2d\u4e70\u989d\u5ea6\uff1f" },
        "a": { "en": "Sign in, open the billing page, pay with Alipay/Stripe.", "zh": "\u767b\u5f55\u540e\u5728\u5145\u503c\u9875\u9762\u9009\u62e9\u4ed8\u6b3e\u65b9\u5f0f\u3002" }
      }
    ]
  }
}`

function loadHomeConfigTemplate() {
  if (form.home_config && form.home_config.trim() && !confirm('Replace existing Home Config with the starter template?')) {
    return
  }
  form.home_config = HOME_CONFIG_TEMPLATE
  homeConfigError.value = ''
}

function formatHomeConfig() {
  if (!form.home_config || !form.home_config.trim()) {
    homeConfigError.value = ''
    return
  }
  try {
    const parsed = JSON.parse(form.home_config)
    form.home_config = JSON.stringify(parsed, null, 2)
    homeConfigError.value = ''
  } catch (e) {
    homeConfigError.value = (e as Error).message
  }
}
